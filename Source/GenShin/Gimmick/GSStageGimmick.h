...
#include "GSStageGimmick.generated.h"
...
UCLASS()
class GENSHIN_API AGSStageGimmick : public AActor
{
	GENERATED_BODY()
...
protected:
	...
	TSubclassOf<class AGSItemBox> RewardBoxClass;

	UPROPERTY(VisibleAnywhere, Category = Reward, Meta = (AllowPrivateAccess = "true"))
	TArray<TWeakObjectPtr<class AGSItemBox>> RewardBoxes;
